...
import Add from "./addthucuong"
import ChiTiet from "./chitietthucuong"
        ...
        <div>
                        ...
                        return (
                            <p onClick={() => {
                                ...
                                axios.get(`/thucuong/thucuongbyloai?idloai=${data.ltuId}`)
                                    ...
                                    .catch((e) => alert(e));
                            }} className="ms-2" style={{ borderRight: "1px solid black", paddingRight: "10px", cursor: "pointer", color: loai === data.ltuTen ? "#D2B48C" : "black" }}>
                                {data.ltuTen}
                            </p>
                        )
                    })
            ...
            <div className="d-flex position-relative">
                ...
                <div>
                    <button onClick={() => {
                        seta(true)
                    }} className="position-absolute top-0 end-0" style={{ backgroundColor: "#1C0F0A", color: "white", borderRadius: "10px" }}>thêm thức uống mới</button>
                </div>
                ...
                openkm && (km[id.current].khuyenmai.kmtt.length != 0 || km[id.current].khuyenmai.kmgv.length != 0) ? <>
                    <div style={{
                        ...
                        {km[id.current].khuyenmai.kmtt.length != 0 ? <div>
                            <strong><h5 style={{ textAlign: "center" }}>Khuyến mãi thông thường</h5></strong>
                            <hr></hr>
                            <div className="row">
                            <div className="col-3">Tên khuyến mãi  </div>
                            <div className="col-3">Giá trị khuyến mãi</div>
                            <div className="col-3">Số lượng áp dụng</div>
