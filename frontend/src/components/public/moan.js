...
import Add from "./addmonan"
import ChiTiet from "./chitietmonan"
        ...
        <div>
                        ...
                        return (
                            <p onClick={() => {
                                ...
                                axios.get(`/monan/byloai?idloai=${data.id}`)
                                    ...
                                    .catch((e) => alert(e));
                            }} className="ms-2" style={{ borderRight: "1px solid black", paddingRight: "10px", cursor: "pointer", color: loai === data.tenLoai ? "#D2B48C" : "black" }}>
                                {data.tenLoai}
                            </p>
                        )
                    })
            ...
            <div className="d-flex position-relative">
                ...
                <div>
                    <button onClick={() => {
                        seta(true)
                    }} className="position-absolute top-0 end-0" style={{ backgroundColor: "#1C0F0A", color: "white", borderRadius: "10px" }}>thêm món mới</button>
                </div>
