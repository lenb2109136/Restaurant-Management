...
import Add from "../public/addcombo"
import ChiTiet from "../public/chitietcombo"
import Backdrop from '@mui/material/Backdrop';
import HienThi from "../public/dsmonancombo"
...
export default function (prop) {
    ...
    return (
        <div style={{border:"2px solid black",position:"fixed",top:"10%",right:"2%",borderRadius:"20px",width:"95%",backgroundColor:"white"}}>
            <div><img onClick={()=>{
                prop.setopen(false)
                        ...
                        return (
                            <p onClick={() => {
                                ...
                                axios.get(`/combo/getbyloai?idloai=${data.id}`)
                                    ...
                                    .catch((e) => alert(e));
                            }} className="ms-2" style={{ borderRight: "1px solid black", paddingRight: "10px", cursor: "pointer", color: loai === data.ten ? "#7AB730" : "black" }}>
                                {data.ten}
                            </p>
                        )
                    })
            ...
            <div className="mt-3 ms-4 row menu " style={{ backgroundColor: '#7AB730', cursor: "pointer", borderRadius: "10px", marginRight:"6px", maxHeight:"700px", overflowY:"scroll"}}>
                        ...
                        return (
                            <div style={{ borderBottom: "1px solid white", marginLeft: "2px" }} className="row mt-2" key={data.id}>
                                ...
                                <input onClick={(event)=>{
                                    ...
                                    }}   defaultChecked={findIndexById(prop.ds[prop.index].dscb,data.id)!=-1? true: false} type="checkbox"></input>
